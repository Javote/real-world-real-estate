...
check 2 guard-write.sh "$(w "$PWD/packages/api/prisma/migrations/20260418180504_init/migration.sql")" "editar una migración ya aplicada"
...
check 0 guard-write.sh "$(w "$PWD/packages/api/prisma/migrations/20991231_nueva/migration.sql")" "crear una migración nueva"
...
check 2 guard-bash.sh "$(b 'echo x >> packages/api/prisma/migrations/20260418180504_init/migration.sql')" "apendear a una migración aplicada"
