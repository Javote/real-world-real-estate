...
const MATRIZ: Record<string, string> = {
  ...
  "GET /api/v1/investor/favorites": "auth + rol(admin|buyer) + rol(admin|buyer)",
  ...
  "GET /api/v1/developer/progress": "auth + rol(admin|developer)",
  "GET /api/v1/developer/documents": "auth + rol(admin|developer)",
  "GET /api/v1/developer/audit-log": "auth + rol(admin|developer)",
  "POST /api/v1/developer/documents": "auth + rol(admin|developer)",
  "GET /api/v1/developer/kpis": "auth + rol(admin|developer) + rol(admin|developer)",
  "GET /api/v1/developer/projects/:id/units":
    "auth + rol(admin|developer) + rol(admin|developer) + proyecto(id → developer)",
  "POST /api/v1/developer/projects/:id/units":
    "auth + rol(admin|developer) + rol(admin|developer) + proyecto(id → developer)",
  "PATCH /api/v1/developer/units/:id": "auth + rol(admin|developer) + rol(admin|developer)",
  "GET /api/v1/developer/units": "auth + rol(admin|developer) + rol(admin|developer)",
  ...
  "POST /api/v1/developer/contracts/:id/releases/:stageNum":
    "auth + rol(admin|developer) + rol(admin|developer)",
  "POST /api/v1/developer/projects/:id/stages/:stageId/evidence":
    "auth + rol(admin|developer) + rol(admin|developer) + proyecto(id → developer)",
  "GET /api/v1/developer/capital/summary": "auth + rol(admin|developer)",
  "GET /api/v1/developer/capital/monthly": "auth + rol(admin|developer)",
  "GET /api/v1/developer/capital/by-project": "auth + rol(admin|developer)",
  "GET /api/v1/developer/investors": "auth + rol(admin|developer)",
