...
| [`SPEC-112`](SPEC-112-pasada-de-accesibilidad-con-voiceover.md) | La pasada de accesibilidad con VoiceOver, más allá de las live regions | anexo (nace de separar `SPEC-104`) | **abierta 2026-09-22** — sin fecha, nivel 🟢 independiente. Hereda los tres caminos que ya verificaba `SPEC-104` y los amplía a un recorrido representativo de cada rol |
