...
| 2 | Unit tests **≥95% coverage** | Cobertura de líneas ≥95% en **toda la app** (relectura del dueño, 2026-09-21: separar una parte es artificial) | ⚠️ **[`SPEC-017`](SPEC-017-cobertura-95-en-toda-la-app.md), abierta.** Medido el 2026-09-21: API 89,4%, cardano 90,1%, shared 61,2%, web 29,1%; los contratos no tienen métrica de líneas y se cubren con la tabla punto de rechazo → test de `contracts/CLAUDE.md` (85 tests). Antes esta fila daba ✅ leyendo el criterio solo sobre los contratos |
