...
| 2 | Unit tests **≥95% coverage** | Cobertura de líneas ≥95% en **toda la app** (relectura del dueño, 2026-09-21: separar una parte es artificial) | ⚠️ **Falta la web: [`SPEC-019`](SPEC-019-cobertura-de-apps-web.md), abierta** (37% de líneas). [`SPEC-017`](SPEC-017-cobertura-95-en-toda-la-app.md) cerró shared, cardano y contratos; la vara más estricta de la API (branches ≥95%, el resto ≥98%), **[`SPEC-018`](SPEC-018-cobertura-de-apps-api.md), cerrada 2026-09-23 con las cuatro métricas en 100%**. Antes esta fila daba ✅ leyendo el criterio solo sobre los contratos |
