...
| 3 | Trazabilidad de los 62 test IDs de M2-D5 + coverage | **1ª** | El criterio de aceptación no es medible |
...
son la unidad de medida del ≥95% de aceptación de M3, y hoy hay 6 de 62 en el repo, sin ninguna
herramienta de coverage—. Pero se escribe mucho mejor sobre una suite que no arrastra estado, así
...
| Métrica | Valor |
|---|---|
| Test IDs declarados en M2-D5 | 62 |
