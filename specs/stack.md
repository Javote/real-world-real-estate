...
| Migraciones | SQL plano en `apps/api/migrations/`, 4 migraciones, tracking propio (`_migrations`), **un solo runner** (D-052) | idempotentes en el `startCommand` | ● — verificado sobre el **compilado**, contra base nueva y re-aplicando | D-012 · D-049 |
