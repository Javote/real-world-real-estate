...
| 3.15 | **Cobertura ≥95% con unit tests en toda la app** — el dueño releyó el criterio el 2026-09-21: es de toda la app, no solo de los contratos. `SPEC-017` cerró shared, cardano y contratos; **la web cerró los lotes W0–W9 el 2026-09-23 con las cuatro métricas en 100%; queda solo CI y evidencia**, en [`specs/SPEC-019-cobertura-de-apps-web.md`](specs/SPEC-019-cobertura-de-apps-web.md), con CI y evidencia al final. La vara más estricta de la API (branches ≥95%, el resto ≥98%), en [`specs/SPEC-018-cobertura-de-apps-api.md`](specs/SPEC-018-cobertura-de-apps-api.md), **cerró el 2026-09-23 con las cuatro métricas en 100%** — lo único que sigue abierto de este ítem es la consolidación de SPEC-019 (umbrales, CI, evidencia) | 2 ⚠️ |
