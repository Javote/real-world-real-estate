...
| 3.15 | **Cobertura ≥95% con unit tests en toda la app** — el dueño releyó el criterio el 2026-09-21: es de toda la app, no solo de los contratos. `SPEC-017` cerró shared, cardano y contratos; **falta la web (37% de líneas)**, en [`specs/SPEC-019-cobertura-de-apps-web.md`](specs/SPEC-019-cobertura-de-apps-web.md), con CI y evidencia al final. La vara más estricta de la API (branches ≥95%, el resto ≥98%), en [`specs/SPEC-018-cobertura-de-apps-api.md`](specs/SPEC-018-cobertura-de-apps-api.md), **cerró el 2026-09-23 con las cuatro métricas en 100%** — lo único que sigue abierto de este ítem es SPEC-019 (la web) | 2 ⚠️ |
